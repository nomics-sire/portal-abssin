      ...
      <div className="w-full max-w-3xl mx-auto bg-white rounded-lg shadow p-6">
        ...
        >
          {[
            ...
            <div key={name as string}>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                {label}
                {name === "coy_name" && <span className="text-red-600"> *</span>}
                {name === "companytin" && <span className="text-red-600"> *</span>}
                {name === "regist_name" && <span className="text-red-600"> *</span>}
                {name === "staff_strength" && <span className="text-red-600"> *</span>}
                {name === "enterprise_reg_no" && <span className="text-red-600"> *</span>}
                {name === "type_of_organisation" && <span className="text-red-600"> *</span>}
                {name === "date_of_incorporation" && <span className="text-red-600"> *</span>}
                {name === "date_of_commencement" && <span className="text-red-600"> *</span>}
                {name === "e_mail" && <span className="text-red-600"> *</span>}
                {name === "phone_no" && <span className="text-red-600"> *</span>}
                {name === "house_no" && <span className="text-red-600"> *</span>}
                {name === "street" && <span className="text-red-600"> *</span>}
                {name === "city" && <span className="text-red-600"> *</span>}
                {name === "ward" && <span className="text-red-600"> *</span>}
                {name === "password" && <span className="text-red-600"> *</span>}
              </label>
              <input
          ...
          <div className="md:col-span-2 mt-4">
            <button
              type="submit"
              className="w-full bg-red-700 cursor-pointer text-white py-2 px-4 rounded hover:bg-red-800 text-sm"
            >
